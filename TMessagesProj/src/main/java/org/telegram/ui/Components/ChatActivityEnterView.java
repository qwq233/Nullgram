...
//        }
    ...
    public boolean sendMessage() {
        if (isInScheduleMode()) {
            ...
            return sendMessageInternal(!Config.alwaysSendWithoutSound, 0, 0, 0, true);
        }
    }
...
//        }
    ...
    public void updateSendAsButton(boolean forceHide, boolean animated) {
        ...
        boolean isVisible =  !forceHide && (((chat != null && chat.creator) || UserConfig.getInstance(currentAccount).isPremium()) || ChatObject.isChannel(chat)) 
