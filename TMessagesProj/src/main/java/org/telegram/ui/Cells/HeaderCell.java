...
public class HeaderCell extends FrameLayout {
    ...
    public HeaderCell(Context context, int textColorKey, int padding, int topMargin, boolean text2, boolean animated) {
        this(context, textColorKey, padding, topMargin, 0, text2, animated, null);
    }
