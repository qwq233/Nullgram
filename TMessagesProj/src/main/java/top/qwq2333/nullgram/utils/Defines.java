...
public class Defines {
    ...
    public static final String autoDisableBuiltInProxy = "autoDisableBuiltInProxy";
    ...
    public static final String disableStickersAutoReorder = "disableStickersAutoReorder";
    ...
    // Tab Menu
    public static final String hasUpdateDialogFilterDatabase = "hasUpdateDialogFilterDatabaseFix";
